...
const GreetingsSection = () => {
  return (
    <section id="greetings" className="py-24 bg-slate-50">
          ...
          <div className="lg:w-1/2">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-slate-900/80 to-transparent p-8">
                ...
                <p className="text-blue-200 text-sm">하나주택종합관리 대표이사</p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:w-1/2">
            ...
            >
              <h2 className="text-primary font-bold mb-6 flex items-center space-x-2">
                ...
                <span className="text-lg">대표 인사말</span>
              </h2>
              <h3 className="text-4xl md:text-5xl font-bold text-slate-900 leading-[1.25] mb-10 tracking-tight">
                "화려한 약속보다 <br />정직한 결과로 보답하겠습니다"
              </h3>
              
              <div className="space-y-8 text-slate-700 leading-[1.8] text-xl">
                <p>
                  안녕하십니까. <span className="text-slate-950 font-bold">하나주택종합관리 대표 박창섭</span>입니다. 
                ...
                <div className="pt-10 border-t border-slate-200 flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className="w-14 h-14 rounded-full bg-slate-100 flex items-center justify-center text-primary font-bold text-xl shadow-inner border border-slate-200">H</div>
                    <div>
                       <p className="text-slate-500 text-sm font-medium mb-1">하나주택종합관리 대표이사</p>
                       <p className="text-slate-900 font-bold text-xl">박 창 섭</p>
                    </div>
                  </div>
